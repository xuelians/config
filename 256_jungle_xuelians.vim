...
" Generated by http://bytefluent.com/vivify 2016-09-13
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Identifier guifg=#fafa64 guibg=NONE guisp=NONE gui=bold,italic ctermfg=227 ctermbg=NONE cterm=bold
...
hi Todo guifg=#ffff00 guibg=NONE guisp=NONE gui=bold ctermfg=11 ctermbg=NONE cterm=bold
hi Special guifg=#d78700 guibg=NONE guisp=NONE gui=NONE ctermfg=172 ctermbg=NONE cterm=NONE
hi LineNr guifg=#ffff00 guibg=#121212 guisp=#121212 gui=NONE ctermfg=11 ctermbg=233 cterm=NONE
...
hi Search guifg=#af005f guibg=#ffff08 guisp=#ffff08 gui=NONE ctermfg=125 ctermbg=11 cterm=NONE
hi Delimiter guifg=#d78700 guibg=NONE guisp=NONE gui=NONE ctermfg=172 ctermbg=NONE cterm=NONE
hi Statement guifg=#fab300 guibg=NONE guisp=NONE gui=NONE ctermfg=214 ctermbg=NONE cterm=NONE
hi Comment guifg=#00c8ff guibg=NONE guisp=NONE gui=NONE ctermfg=45 ctermbg=NONE cterm=NONE
...
hi Function guifg=#63ff63 guibg=NONE guisp=NONE gui=bold ctermfg=83 ctermbg=NONE cterm=bold
hi FoldColumn guifg=#af5f87 guibg=NONE guisp=NONE gui=NONE ctermfg=132 ctermbg=NONE cterm=NONE
hi PreProc guifg=#ff6464 guibg=NONE guisp=NONE gui=NONE ctermfg=9 ctermbg=NONE cterm=NONE
...
hi Type guifg=#67ff64 guibg=NONE guisp=NONE gui=NONE ctermfg=83 ctermbg=NONE cterm=NONE
...
hi String guifg=#787878 guibg=NONE guisp=NONE gui=NONE ctermfg=243 ctermbg=NONE cterm=NONE
